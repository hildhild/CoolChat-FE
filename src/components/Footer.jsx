            ...
            <div className='w-full max-w-[1140px] px-[32px] my-[0px] mx-[auto]'>
                <div className="md:flex border-b-[0.8px] border-[#8787875c]">
                    <div className="md:w-[400px] px-[32px] sm:px-[16px] py-[32px] grid grid-cols-1 sm:grid-cols-3 md:block w-full">
                        ...
                        <div className="text-[14px] text-[#9a9a9a]"><strong>{t('address2_1')}</strong> {t('address2_2')}</div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 w-full">
                        <div className="col-span-1 px-[32px] py-[32px]">
                            <div className=" mb-3 font-semibold uppercase">{t('about_us')}</div>
                            <div className="mb-3">
                                <a href="#" className="text-[14px] transition duration-200 delay-100 text-[#9a9a9a] no-underline hover:underline-offset-4 hover:underline hover:text-white">{t('about_us')}</a>
                            </div>
                            <div className="mb-3">
                                <a href="#" className="text-[14px] transition duration-200 delay-100 text-[#9a9a9a] no-underline hover:underline-offset-4 hover:underline hover:text-white">{t('our_values')}</a>
                            </div>
                            <div className="mb-3">
                                <a href="#" className="text-[14px] transition duration-200 delay-100 text-[#9a9a9a] no-underline hover:underline-offset-4 hover:underline hover:text-white">{t('careers')}</a>
                            </div>
                            <div className="mb-3">
                                <a href="#" className="text-[14px] transition duration-200 delay-100 text-[#9a9a9a] no-underline hover:underline-offset-4 hover:underline hover:text-white">{t('awards')}</a>
                            </div>
                            <div>
                                <a href="#" className="text-[14px] transition duration-200 delay-100 text-[#9a9a9a] no-underline hover:underline-offset-4 hover:underline hover:text-white">Blog</a>
                            </div>
                        </div>
                        <div className="col-span-1 px-[32px] py-[32px]">
                            <div className=" mb-3 font-semibold uppercase">{t('price')}</div>
                            <div className="mb-3">
                                <a href="#" className="text-[14px] transition duration-200 delay-100 text-[#9a9a9a] no-underline hover:underline-offset-4 hover:underline hover:text-white">{t('for_enterprise')}</a>
                            </div>
                            <div className="mb-3">
                                <a href="#" className="text-[14px] transition duration-200 delay-100 text-[#9a9a9a] no-underline hover:underline-offset-4 hover:underline hover:text-white">{t('for_university')}</a>
                            </div>
                            <div className="mb-3">
                                <a href="#" className="text-[14px] transition duration-200 delay-100 text-[#9a9a9a] no-underline hover:underline-offset-4 hover:underline hover:text-white">{t('for_individual_group')}</a>
                            </div>
                            <div className="mb-3">
                                <a href="#" className="text-[14px] transition duration-200 delay-100 text-[#9a9a9a] no-underline hover:underline-offset-4 hover:underline hover:text-white">{t('for_student')}</a>
                            </div>
                ...
                <div className="pt-[20px] pb-[32px] text-[13px] block md:flex justify-between px-[32px] sm:px-[16px]">
                    <div className="flex mb-[10px] md:mb-0">
                        <a href="#" className="transition duration-200 delay-100 text-[#9a9a9a] mr-[20px] no-underline hover:underline-offset-4 hover:underline hover:text-white">{t('privacy_policy')}</a>
                        <a href="#" className="transition duration-200 delay-100 text-[#9a9a9a] no-underline hover:underline-offset-4 hover:underline hover:text-white">{t('terms_of_service')}</a>
                    </div>
